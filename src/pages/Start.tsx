  ...
  return (
    <main className="landing">
      <section className="landing-hero">
        <div className="landing-badge">Solicare</div>
      ...
      <section className="landing-features">
        <div className="feature-card">
          ...
          <p className="feature-text">심박수와 체온을 직관적인 그래프로 볼 수 있어요.</p>
        </div>
        <div className="feature-card">
          <div className="feature-icon">🔔</div>
          <h3 className="feature-title">즉시 알림</h3>
          <p className="feature-text">낙상 감지 등 긴급 상황을 빠르게 알려드립니다.</p>
        </div>
        <div className="feature-card">
          <div className="feature-icon">🔒</div>
          <h3 className="feature-title">안전한 접근</h3>
          <p className="feature-text">로그인 후에만 보호자 전용 데이터를 볼 수 있어요.</p>
        </div>
      </section>
    </main>
  );
